        ...
        <div className="bg-transparent animate-in fade-in duration-500">
            <header className="mb-8 border-b border-border pb-6 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                <div>
                    ...
                    <h2 className="text-xl md:text-2xl font-heading font-black uppercase tracking-tight text-foreground">Users</h2>
                ...
                <div className="relative group">
                    ...
                    <input
                        ...
                        className="pl-11 pr-4 py-3 text-xs bg-card border border-border rounded-none w-full lg:w-72 focus:outline-none focus:border-[#2563EB] transition-all font-heading font-bold placeholder:text-muted-foreground/40"
                    />
                </div>
                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-background border-b border-border text-muted-foreground">
                            <th className="px-4 md:px-6 py-4 text-[9px] font-heading font-black uppercase tracking-widest text-muted-foreground/60">User</th>
                            <th className="hidden md:table-cell px-6 py-4 text-[9px] font-heading font-black uppercase tracking-widest text-muted-foreground/60">Email</th>
                            <th className="hidden lg:table-cell px-6 py-4 text-[9px] font-heading font-black uppercase tracking-widest text-muted-foreground/60">Verification Status</th>
                            <th className="px-4 md:px-6 py-4 text-[9px] font-heading font-black uppercase tracking-widest text-muted-foreground/60">Role</th>
                            <th className="px-4 md:px-6 py-4 text-[9px] font-heading font-black uppercase tracking-widest text-muted-foreground/60 text-right">Actions</th>
                        </tr>
                    </thead>
                                ...
                                <td className="hidden lg:table-cell px-6 py-4">
                                    <div className="flex flex-col gap-2">
                                        {user.verificationStatus === 'verified_premium' ? (
                                            ...
                                            <span className="px-2.5 py-1 text-[9px] font-heading font-black uppercase tracking-widest rounded-none bg-muted text-muted-foreground/40 border border-transparent w-fit">None</span>
                                        )}
