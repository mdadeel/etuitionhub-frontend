...
const ChatInterface = () => {
    ...
    return (
        <div className="flex h-[calc(100vh-140px)] min-h-[600px] bg-white border border-[rgba(15,23,46,0.08)] rounded-xl overflow-hidden shadow-sm">
            {/* Left Sidebar: Conversations */}
            <div className="w-1/3 min-w-[280px] max-w-[350px] border-r border-[rgba(15,23,46,0.08)] flex flex-col bg-[#F9FAFB]">
                <div className="p-4 border-b border-[rgba(15,23,46,0.08)] bg-white">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-4 py-2 text-sm bg-[#EEF2F6] border border-transparent rounded-lg focus:outline-none focus:border-[#2563EB]/30 focus:bg-white transition-all"
                        />
                    </div>
                </div>
            ...
            <div className="flex-1 flex flex-col bg-white">
                {activeConversation ? (
                                        ...
                                        <div key={idx} className={cn("flex", isMe ? "justify-end" : "justify-start")}>
                                            <div className={cn(
                                                ...
                                                isMe 
                                                    ...
                                                    : "bg-white border border-[rgba(15,23,46,0.08)] text-[#111827] rounded-bl-none shadow-sm"
                                            )}>
                                                <p>{msg.text}</p>
                                                <span className={cn(
                                                    "text-[9px] block mt-1",
                        ...
                        <div className="p-4 bg-white border-t border-[rgba(15,23,46,0.08)]">
                            <form onSubmit={sendMessage} className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 px-4 py-2.5 bg-[#EEF2F6] border border-transparent focus:bg-white focus:border-[#2563EB]/30 rounded-xl outline-none text-sm transition-all"
                                />
                                <button 
                                    type="submit"
                                    disabled={!newMessage.trim()}
                                    className="px-4 py-2.5 bg-[#2563EB] text-white rounded-xl hover:bg-[#1D4ED8] disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center"
                                >
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-[#5B6475]">
                        <div className="w-16 h-16 bg-[#EEF2F6] rounded-full flex items-center justify-center mb-4">
