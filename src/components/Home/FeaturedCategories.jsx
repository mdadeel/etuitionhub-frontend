            ...
            >
                ...
                {tag && TagIcon && (
                    ...
                    >
                        ...
                        <span className="hidden md:inline text-[11px] font-bold uppercase tracking-wider">{cat.tag}</span>
                    </span>
                )}
                ...
                <div className="relative z-10 flex h-full flex-col p-3 md:p-4">
                    ...
                    <div className="mt-3 flex items-center justify-between border-t border-border/60 pt-2 md:pt-2.5">
                        <span className="text-[11px] md:text-[11px] font-bold text-foreground">
                            Browse tutors
                        </span>
                    ...
                    >
                        <div className="mb-2 inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-primary/5 px-2.5 py-1">
                            ...
                            <span className="text-[11px] font-bold uppercase tracking-widest text-primary">
                                {t('featuredCategories.badge')}
                            </span>
                        </div>
                        <h2 className="text-2xl md:text-3xl font-heading font-bold leading-tight tracking-tight text-foreground">
                            {t('featuredCategories.heading')}
                        </h2>
                    </div>

                    <Link
                        to="/tutors"
                        className="group inline-flex items-center gap-1.5 self-start rounded-full border border-border bg-background px-4 py-2 text-xs font-bold text-foreground transition-all duration-300 hover:border-primary/40 hover:bg-primary hover:text-primary-foreground hover: md:self-end"
                    >
                    ...
                    >
                        <div
                            className={cn(
                                ...
                                "transition-all duration-300 ease-out",
                                "hover:border-primary/40 hover:bg-primary/5 hover:",
                                "active:scale-[0.985]"
                            )}
                        >
                            <div className="flex items-center gap-2.5 mb-2 md:mb-3 min-w-0">
                            ...
                            <div className="mt-3 flex items-center justify-between border-t border-border/60 pt-2 md:pt-2.5">
                                <span className="text-[11px] md:text-[11px] font-bold text-primary group-hover:underline">{t('popularTutors.view_all')}</span>
