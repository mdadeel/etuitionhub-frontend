                ...
                <div className="max-w-4xl">
                    ...
                    <div className="mt-12 flex flex-wrap gap-12 items-center border-t border-white/10 pt-10">
                        <div className="flex flex-col">
                            ...
                            <span className="text-[9px] font-black text-muted-foreground uppercase tracking-[0.2em] mt-1">Verified Profiles</span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-3xl font-black text-white tracking-tighter">0৳</span>
                            <span className="text-[9px] font-black text-muted-foreground uppercase tracking-[0.2em] mt-1">Agent Commission</span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-3xl font-black text-white tracking-tighter">Direct</span>
                            <span className="text-[9px] font-black text-muted-foreground uppercase tracking-[0.2em] mt-1">Direct Contact</span>
                        </div>
                    </div>
                </div>
            </div>
