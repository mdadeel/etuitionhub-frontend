                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="order-2 md:order-1">
                        <div className="relative">
                            ...
                            />
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-lg shadow-xl max-w-xs hidden lg:block">
                                ...
                                <p className="text-sm text-gray-600 font-medium">New students joined this week to find their perfect tutor.</p>
                            </div>
                        </div>
                    </div>
