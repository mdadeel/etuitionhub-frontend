// Why Choose Us Section - Features section from req.md
// Copied structure from HowItWorks - maybe extract common component later
...
function WhyChooseUs() {
    const features = [
        ...
        },
        {
            ...
            description: "Choose tutors based on your available days and time slots"
        },
        {
            icon: <FaStar className="text-3xl text-teal-600" />,
            title: "Quality Education",
            description: "Experienced and qualified tutors to help you succeed"
        }
    ];
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {features.map((feature, index) => (
                        <div key={index} className="bg-base-100 p-6 rounded-lg shadow-md text-center">
