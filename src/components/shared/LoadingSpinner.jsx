const LoadingSpinner = ({ size = 'lg', fullScreen = true }) => {
    ...
    const sizeClass = size === 'lg' ? 'size-12' : 'size-6';
            ...
            <div className="flex flex-col items-center gap-6">
                <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="size-1.5 bg-primary rounded-full opacity-40 animate-pulse"></div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex gap-1 mt-2">
                        <div className="size-1 bg-primary/70 rounded-full animate-bounce [animation-delay:-0.3s]"></div>
                        <div className="size-1 bg-primary/70 rounded-full animate-bounce [animation-delay:-0.15s]"></div>
                        <div className="size-1 bg-primary/70 rounded-full animate-bounce"></div>
                    </div>
                </div>
            </div>
        </div>
