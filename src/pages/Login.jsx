                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div className="bg-slate-50 p-8 flex flex-col justify-center">
                            <div className="space-y-4">
                                <div>
                                    <h3 className="text-base font-medium text-slate-900 mb-1">Other Options</h3>
                                    <p className="text-sm text-slate-500">Connect with other methods</p>
                                </div>
                                ...
                                <div className="pt-4 border-t border-slate-200">
                                    <p className="text-sm text-slate-500 mb-2">New to e-TuitionBD?</p>
                                    <Link
                                        to="/register"
