...
const Home = () => {
    ...
    return (
        <div className="bg-background">
            ...
            {!user && (
              <section className="bg-gradient-to-r from-primary/5 to-accent/5 border-y border-border/30">
                <div className="max-w-4xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div>
                    <p className="text-sm font-semibold text-foreground">Are you a tutor?</p>
                    <p className="text-xs text-muted-foreground">Join 2,500+ verified tutors across Bangladesh</p>
                  </div>
                  <Link
                    to="/register"
